...
ActiveRecord::Schema.define(version: 20150323022727) do
  ...
  add_index "nutritionist_profiles", ["nutritionist_id"], name: "index_nutritionist_profiles_on_nutritionist_id"
