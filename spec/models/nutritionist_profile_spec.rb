...
RSpec.describe NutritionistProfile, :type => :model do
  ...
  describe "Validate Nutritionist Profile" do
    ...
    describe "validate issuing_institution" do
      ...
      it "validate creation of the Nutritionist Profile (field issuing_institution is valid using the option 'CRN-5')" do
        n = NutritionistProfile.new(profile)
        n.issuing_institution = "CRN-5"
        expect(n.valid?).to be true
      end
      ...
      it "validate creation of the Nutritionist Profile (field issuing_institution is valid using the option 'CRN-7')" do
        n = NutritionistProfile.new(profile)
        n.issuing_institution = "CRN-7"
        expect(n.valid?).to be true
      end

      it "validate creation of the Nutritionist Profile (field issuing_institution is valid using the option 'CRN-8')" do
        n = NutritionistProfile.new(profile)
        n.issuing_institution = "CRN-8"
        expect(n.valid?).to be true
      end

      it "validate creation of the Nutritionist Profile (field issuing_institution is valid using the option 'CRN-9')" do
        n = NutritionistProfile.new(profile)
        n.issuing_institution = "CRN-9"
        expect(n.valid?).to be true
      end

      it "validate creation of the Nutritionist Profile (field issuing_institution is valid using the option 'CRN-10')" do
        n = NutritionistProfile.new(profile)
        n.issuing_institution = "CRN-10"
        expect(n.valid?).to be true
      end
