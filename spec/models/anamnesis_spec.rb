...
RSpec.describe Anamnesis, :type => :model do
  let(:valid_anamnesis) {{medical_register_id: 00000000, morning_meal_time: Time.new, noon_meal_time: (Time.new + 1.hour), evening_meal_time: (Time.new + 6.hour), patient_id: 1 }}
